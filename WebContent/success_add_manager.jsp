...
<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta http-equiv="refresh" content="3;URL=manager_insert.jsp">
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Success Add Manager</title>
</head>
<body>
<!--start-header-->
	...
	<div class="services">
		<div class="container">
			<div class="services-top heading">
				<h3>已成功添加管理员！3秒后自动跳转至添加界面...</h3>
			<p><a href="manager_insert.jsp">若你的浏览器没响应，则点击此处返回</a></p>
			</div>
		<div class="clearfix"></div>				
			</div>			
		</div>
