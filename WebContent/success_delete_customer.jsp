...
<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta http-equiv="refresh" content="3;URL=CustomerAction!list">
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Success Delete Customer</title>
</head>
<body>
<!--start-header-->
	...
	<div class="services">
		<div class="container">
			<div class="services-top heading">
				<h3>已成功删除会员！3秒后自动跳转至会员信息界面...</h3>
			<p><a href="CustomerAction!list">若你的浏览器没响应，则点击此处返回</a></p>
			</div>
		<div class="clearfix"></div>				
			</div>			
		</div>
