...
<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Review To OrderList</title>
</head>
<body>
	<!--start-header-->
	...
	<div class="contact">
		<div class="container">
			...
			<%
				int ocd_id=(int)session.getAttribute("ocd_id"); 
				session.setAttribute("ocd_id", ocd_id);
			%>
			<s:form action="OrderlistAction!review" theme="simple">
				<div class="contact-bottom">
     		   	<s:textarea name="orderlist.cus_review" placeholder="Message"/>
