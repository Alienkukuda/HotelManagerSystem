...
<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Charge</title>
</head>
<body>
	<!--start-header-->
			...
			<div class="head">
				...
				<div class="navigation">
					...
					<ul class="navig">
						...
						<li><a href="customer_charge.jsp" class="active hvr-bounce-to-bottom">账户充值</a></li>
	...
	<div class="contact">
		<div class="container">
			...
			<s:form action="CustomerAction!charge" theme="simple">
				<div class="contact-bottom">
     		   	<s:select list="#{0:'微信充值',1:'支付宝充值',2:'银行卡充值' }" name="chargetype"/>
				<s:textfield name="chargemoney" placeholder="Money"/>
