...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<meta http-equiv="refresh" content="3;URL=index_customer_register.jsp">
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Fail To Register</title>
</head>
<body>
<!--start-header-->
	...
	<div class="services">
		<div class="container">
			<div class="services-top heading">
				<h3>抱歉用户名已存在！3秒后自动跳转至注册界面...</h3>
				<p><a href="index_customer_register.jsp">若你的浏览器没响应，则点击此处返回</a></p>
			</div>
		<div class="clearfix"></div>				
			</div>			
		</div>
