...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<meta http-equiv="refresh" content="3;URL=OrderlistAction!findHotelOrderlist">
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Success Order Affirm</title>
</head>
<body>
<!--start-header-->
	...
	<div class="services">
		<div class="container">
			...
			<h3>已确认该订单完成！3秒后自动跳转至我的订单界面...</h3>
			<p><a href="OrderlistAction!findHotelOrderlist">若你的浏览器没响应，则点击此处返回</a></p>
			</div>
		<div class="clearfix"></div>				
			</div>			
		</div>
