...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Insert Manager</title>
</head>
<body>
<!--start-header-->
			...
			<div class="navigation">
				 <span class="menu"></span> 
					<ul class="navig">
						...
						<li><a href="manager_insert.jsp" class="active hvr-bounce-to-bottom">添加管理员</a></li>
	...
	<div class="contact">
		<div class="container">
			...
			<s:form action="ManagerAction!register"  theme="simple">
				<div class="contact-bottom">	
				<s:textfield name = "manager.m_account" placeholder="Account"/>
				<s:password name = "manager.m_password" placeholder = "Password"/>
				<s:textfield name = "manager.m_name" placeholder = "Name"/>
