...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	if(type.equals("0")){%>
		<meta http-equiv="refresh" content="3;URL=index_search_grep.jsp">
	<%} else if(type.equals("1")){ %>
		<meta http-equiv="refresh" content="3;URL=Hotel_cityAction!findHotel">
	<%} %>
	...
	<!--end-smoth-scrolling-->
<title>Paix Hotel Reserve:Success Charge</title>
</head>
<body>
<!--start-header-->
	...
	<div class="services">
		<div class="container">
			<div class="services-top heading">
				<h3>留言成功！3秒后自动跳转至主界面...</h3>
			<%if(type.equals("0")){%>
			<p><a href="index_search_grep.jsp">若你的浏览器没响应，则点击此处返回</a></p>
			<%} else if(type.equals("1")){ %>
			<p><a href="Hotel_cityAction!findHotel">若你的浏览器没响应，则点击此处返回</a></p>
			<%} %>
			</div>
		<div class="clearfix"></div>				
			</div>			
